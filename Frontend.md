...
>
> 如何克服焦虑？结合公司的实际业务，集中精力学相关知识，在业务中迅速提升技术能力。这样既能够保证学习效率，而且学习效果也是立竿见影的。
>
...
[Electron，从玩玩具的心态开始，到打造出一款越来越优秀的桌面客户端产品](https://segmentfault.com/a/1190000011699304)

> ↑↑↑ 学习什么技术不重要，关键的是有没有一个好的方法论可以让自己高效地学习！个人认为精华部分是该文章的第三节：三、该怎么去阅读和学习 Electron 的文档。

[当你一个人想做一个web项目的时候你该怎么做](https://zhuanlan.zhihu.com/p/20575952)

> ↑↑↑ 如果想一个人做一个 Web 项目，比如建立自己的博客，也建议按照一个完整的流程做下来，这样的收获会比单纯地撸代码要多很多。

### 前端学习

[学习前端我推荐这5本书](http://www.jianshu.com/p/3cf51d3dbb73)

> ↑↑↑ 《Web 前端开发最佳实践》《编写可维护的 JavaScript》和《JavaScript 设计模式与开发实践》应该很有看头，前两本已经从图书馆借来了
>
> 另外一本《图解 HTTP》普遍都在推荐的
> 
